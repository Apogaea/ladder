...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'exchange_ticketrequest', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ticket_requests', to=orm['accounts.User'])),
        ...
        db.create_table(u'exchange_ticketoffer', (
            ...
            ('is_cancelled', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_terminated', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ticket_offers', to=orm['accounts.User'])),
        ...
        db.create_table(u'exchange_ladderprofile', (
            ...
            ('verified_phone_number', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exchange.PhoneNumber'], null=True)),
        ))
        ...
        db.create_table(u'exchange_phonenumber', (
            ...
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='phone_numbers', to=orm['exchange.LadderProfile'])),
            ...
            ('confirmation_code', self.gf('django.db.models.fields.CharField')(default='919591', max_length=255, blank=True)),
    ...
    models = {
        ...
        u'exchange.ladderprofile': {
            ...
            'verified_phone_number': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['exchange.PhoneNumber']", 'null': 'True'})
        },
        u'exchange.phonenumber': {
            ...
            'confirmation_code': ('django.db.models.fields.CharField', [], {'default': "'363193'", 'max_length': '255', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'phone_numbers'", 'to': u"orm['exchange.LadderProfile']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
